...
func main() {
	...
	var pacienteB = paciente.Paciente{ID: primitive.NewObjectID(), Nome: "Guisela Silva", CPF: "194630144-20",
		...
		Bloqueado: false}
	// pacienteA.PlanosPgts = append(pacienteA.PlanosPgts, planoCASSI)
	...
	// Alterando Paciente
	// idpac, _ := primitive.ObjectIDFromHex("6598803dde12b01dc604ef6a")
	...
	// ID, _ := primitive.ObjectIDFromHex("65998064fab6d835ca0f5a60")
	// ConvAlterado = convenio.Convenio{Indisponivel: false, DataContratoConv: d0}
	// fmt.Println("ConvAlterado antes:", ConvAlterado)

	// atualizaConvPorId(ID, ConvAlterado)
	// fmt.Println("ConvAlterado depois:")
	// listaConvenio("uni")
